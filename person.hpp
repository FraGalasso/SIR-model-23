...
class Person {
 ...
 public:
  ...
  // getting vaccination status, defined at line 20 of person.cpp
  bool get_vaccination() const;

  // setting position in 40*40 grid, defined at line 22 of person.cpp
  void set_x(int y);

  // setting movement along the x axis, defined at line 24 of person.cpp
  void set_px(int p);

  // setting movement along the y axis, defined at line 26 of person.cpp
  void set_py(int p);

  // setting health condition, defined at line 28 of person.cpp
  void set_status(Status z);

  // vaccination, sets dot color to blue if the person is still susceptible,
  // defined at line 30 of person.cpp
  void vaccine();
  ...
  // right edge, etc, defined at line 37 of person.cpp
  void update_dot_position();

  // setting dot color, defined at line 53 of person.cpp
